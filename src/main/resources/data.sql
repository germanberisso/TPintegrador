...
INSERT INTO incidente (resuelto,fecha_Desde,fecha_estimada,fecha_hasta,id,alias,consideracion) VALUES (true,STR_TO_DATE('18/02/2019 11:15:45','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('20/02/2019 11:15:45','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('22/02/2019 11:15:45','%d/%m/%Y %H:%i:%s'),1,'windows','windows');
